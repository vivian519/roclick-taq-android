...
public class AimOverlayServiceRed extends Service {
    ...
    public void onCreate() {
        ...
        aim.setImageResource(R.drawable.ic_crosshair_red);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    cfg.put("mode", "fixed_red");
                    cfg.put("fixed_red_cx", fx);
                    cfg.put("fixed_red_cy", fy);
                    boolean ok = ConfigIO.writeConfig(cfg);
                    Toast.makeText(AimOverlayServiceRed.this, ok ? "坐标已保存" : "保存失败", Toast.LENGTH_SHORT).show();
                    stopSelf();
                } catch (Exception e) {
                    Toast.makeText(AimOverlayServiceRed.this, "保存失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
