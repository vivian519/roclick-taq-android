...
public class AimOverlayService extends Service {
    ...
    public void onCreate() {
        ...
        aim.setImageResource(R.drawable.ic_crosshair);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(AimOverlayService.this, ok ? "坐标已保存" : "保存失败", Toast.LENGTH_SHORT).show();
                    stopSelf();
                } catch (Exception e) {
                    Toast.makeText(AimOverlayService.this, "保存失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
