...
public class AimOverlayServiceBlue extends Service {
    ...
    public void onCreate() {
        ...
        aim.setImageResource(R.drawable.ic_crosshair_blue);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    cfg.put("fixed_blue_cx", fx);
                    cfg.put("fixed_blue_cy", fy);
                    boolean ok = ConfigIO.writeConfig(cfg);
                    Toast.makeText(AimOverlayServiceBlue.this, ok ? "坐标已保存" : "保存失败", Toast.LENGTH_SHORT).show();
                    stopSelf();
                } catch (Exception e) {
                    Toast.makeText(AimOverlayServiceBlue.this, "保存失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
